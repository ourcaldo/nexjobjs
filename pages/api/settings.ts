...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Only return public-safe fields (exclude sensitive data like API keys)
    const publicSettings = {
      ...
      sitemap_update_interval: data.sitemap_update_interval,
      auto_generate_sitemap: data.auto_generate_sitemap,
      last_sitemap_update: data.last_sitemap_update,
